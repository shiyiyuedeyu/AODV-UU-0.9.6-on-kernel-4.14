...
void nl_init(void)
{
	...
	peer.nl_pid = 0;/*For linux kernel*/
	peer.nl_groups = 0;
	...
	DEBUG(LOG_DEBUG, 0,"aodvnl.local.nl_pid is %d",aodvnl.local.nl_pid); 
    ...
    /*printf("send sockaddr_nl.nl_pdi is %d",rtnl.local.nl_pid );*/
	DEBUG(LOG_DEBUG, 0,"rtnl.local.nl_pid is %d",rtnl.local.nl_pid );
